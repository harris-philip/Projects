...
public class AddWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        noteLabel.setText("<html>Note: To add compounds with different chemical names,<br> but are the same compound-- you must add each one <br> separately and one at a time.</html>");
